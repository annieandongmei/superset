...
class BaseImportCommand(BaseCommand):
    ...
    A dispatcher iterates over the versioned import commands listed in
    ``command_versions`` until it finds one that can handle the contents.
    Subclasses only need to define ``command_versions``.
    """

    # list of different import formats supported; subclasses must override this
